...
function calculateExpression(expression) {
  let res = "Argument is not a string";
...
function getNumberFromString(s) {
  let error = "Couldn't extract a number from the provided string.";
...
function getIntegerFromString(s) {
  let error = "Couldn't extract an integer from the provided string.";
  if (isNaN(parseInt(s))) {
    return error;
  }
  return parseInt(s);
